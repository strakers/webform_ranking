  ...
  public function testSamePageItemConditionUnaffected(): void {
    $webform = $this->createWebformWithElements('same_page_items', [
      ...
      'ranking' => [
        ...
        // plugin's prepare()) and independently suppresses a
        // conditional row's static 'required' attribute — orthogonal
        // to what this test isolates (only that a same-page condition
        // survives resolveCrossPageItemStates() unclobbered). Off here
        // so the assertion below stays a precise match against the
        // item's own configured condition, not entangled with a second
        // feature. See docs/adr/0018-remove-required-optional-states-mirror.md.
        '#required_all' => FALSE,
        '#items' => [
